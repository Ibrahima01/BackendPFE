...
public class RendezVousController {
    ...
    @PostMapping("/updateNumBox/{id}/{nombreBox}")
    public RendezVous mettreAjourNumBox(@PathVariable Long id, @PathVariable int nombreBox){
        return rendezVvousService.updateNumBox(id, nombreBox);
    }
}
